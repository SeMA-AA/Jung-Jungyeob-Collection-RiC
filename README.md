...
○ 컬렉션시각화 Beta의 대상
- 개관 준비, 수집, 활용 등의 과정 속에서 다양한 관계를 보여줄 수 있는 '정정엽 컬렉션' 선정
- 서울시립 미술아카이브가 수집하여 소장·관리하고 있는 컬렉션
- 서울시립미술관이 소장하고 있는 작품과 관련된 컬렉션
- 교육 프로그램에 활용한 예술자료를 포함하는 컬렉션
- 서울시립 미술아카이브의 전거 레코드, 시소러스 등 콘텐츠와 관련된 컬렉션
- 미술관 본관 및 서울시립 미술아카이브의 법률·규정 등을 적용 받는 컬렉션
...
○ 업무 프로세스 절차도 작성
- 컬렉션의 맥락을 한눈에 파악하기 위해 수집, 교육, 업무이관의 세 단계로 구분한 업무 프로세스 절차도를 작성했습니다. 여기에는 예술자료, 기관자료(결재문서 포함), 소장품, 인물, 단체, 부서, 교육 프로그램, 미술용어 등이 포함되었으며 각 맥락정보들을 선으로 연결해 관계를 표현했습니다.
...
- 절차도의 맥락정보는 RiC-CM의 ‘개체(entity)’, 맥락정보의 속성값은 개체의 ‘속성(attribute)’, 맥락정보를 잇는 선은 개체 간 ‘관계(relation)’로 매핑했습니다. RiC을 적용하니 절차도를 작성할 때는 미처 포함하지 못했던 관계들까지 파악할 수 있었고, 그 결과로 개체 184개와 속성 2,229개, 관계 2,283개를 도출했습니다.
...
| RiC-E03 | Record&nbsp;Set | 컬렉션, 시리즈, 서브시리즈, 파일 |
| RiC-E04 | Record | 예술자료(소장품 관련, 컬렉션시각화 관련), 기관자료(부서별 결재문서, 교육 프로그램 관련 문서) |
| RiC-E05 | Record&nbsp;Part | - |
| RiC-E06 | Instantiation | 예술자료의 첨부파일(디지털화 결과) |
| RiC-E07 | Agent | - |
| RiC-E08 | Person | 작가, 학예연구사, 기록연구사, 독립연구자 |
| RiC-E09 | Group | - |
| RiC-E10 | Family | - |
...
| RiC-E14 | Event | - |
| RiC-E15 | Activity | 협약, 사업, 교육 프로그램, 전시 |
| RiC-E16 | Rule | 법령, 자치법규, 서울시립 미술아카이브 규정, 서울시립 미술아카이브 매뉴얼 |
| RiC-E17 | Mandate | - |
| RiC-E18 | Date | 기간, 교육시작일, 교육종료일 |
| RiC-E22 | Place | 보존공간 |
...
○ 구축 대상: 정정엽 컬렉션
- [정정엽 컬렉션 온톨로지 그래프 바로가기(클릭) - 시작점: 두렁](http://121.131.4.200:7200/graphs-visualizations?saved=b4af1ae2f5324fc0a8ca8728403cec05)
- [정정엽 컬렉션 온톨로지 그래프 바로가기(클릭) - 시작점: 민중미술](http://121.131.4.200:7200/graphs-visualizations?saved=1b7ea51e7c594acc934bba7be297dacc)
- [정정엽 컬렉션 온톨로지 그래프 바로가기(클릭) - 시작점: 여성미술연구회](http://121.131.4.200:7200/graphs-visualizations?saved=1e11cf6513204c2a906c77bb892e022c)
- [정정엽 컬렉션 온톨로지 그래프 바로가기(클릭) - 시작점: 입김](http://121.131.4.200:7200/graphs-visualizations?saved=622ed4ea563c44e597ab7373148ba76d)
...
- 하지만 RiC을 적용하면 컬렉션뿐만 아니라 수집 과정, 교육 프로그램 활용, 업무이관 등 컬렉션을 둘러싸고 있는 맥락정보를 누락 없이 모두 포괄하여 세부적으로 모델링할 수 있었습니다.
