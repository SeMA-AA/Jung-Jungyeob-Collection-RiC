...
- The *Jung Jungyeob Collection* was selected for its potential to illustrate diverse relationships across the processes of preparation for SeMA AA's opening, acquisition, and utilization.
- Collections acquired, held, and managed by SeMA AA
- Collections related to artworks held in the collection of SeMA
- Collections that include artistic materials used in educational programs
...
- To provide a clear overview of the collection’s contextual relationships, we created a workflow diagram organized into three stages: acquisition, education, and Institutional handover. The diagram includes elements such as artistic materials, institutional records (including approval documents), collection items, individuals, organizations, departments, eudcational programs, and art-related terminology. This contextual information is connected with lines to illustrate the relationships between elements.
...
| RiC-E03 | Record&nbsp;Set | Collection, Series, Subseries, File |
| RiC-E04 | Record | Art Records, Institutional Records(e.g., departmental approval documents, documents related to educational promgrams) |
| RiC-E05 | Record&nbsp;Part | - |
| RiC-E06 | Instantiation | Attachments of Art Records(digitized outputs) |
| RiC-E07 | Agent | - |
| RiC-E08 | Person | Artist, Curator, Archivist, Independent Researcher |
| RiC-E09 | Group | - |
| RiC-E10 | Family | - |
...
| RiC-E14 | Event | - |
| RiC-E15 | Activity | Agreement, Project, Educational Program, Exhibition |
| RiC-E16 | Rule | Laws, Ordinances, SeMA AA Regulations, SeMA AA Manuals |
| RiC-E17 | Mandate | - |
| RiC-E18 | Date | Date, Educational program start date, Educational program end date |
| RiC-E22 | Place | Archival Storage |
...
○ Applied Standards: RiC-CM (v1.0), RiC-O (v1.1)

○ Target Collection: Jung Jungyeob Collection
- [Access the Jung Jungyeob Collection Ontology Graph (Click) - starting node: Dureong](http://121.131.4.200:7200/graphs-visualizations?saved=b4af1ae2f5324fc0a8ca8728403cec05)
- [Access the Jung Jungyeob Collection Ontology Graph (Click) - starting node: Minjung Art](http://121.131.4.200:7200/graphs-visualizations?saved=1b7ea51e7c594acc934bba7be297dacc)
- [Access the Jung Jungyeob Collection Ontology Graph (Click) - starting node: Women’s Art Research Association](http://121.131.4.200:7200/graphs-visualizations?saved=1e11cf6513204c2a906c77bb892e022c)
- [Access the Jung Jungyeob Collection Ontology Graph (Click) - starting node: Ipgim](http://121.131.4.200:7200/graphs-visualizations?saved=622ed4ea563c44e597ab7373148ba76d)

    ※ Login is required to ensure a consistent operating environment. (Username: user / Password: semaaa)

    ※ If the graph does not display immediately, go to the left-hand menu and select Explore > Visual graph, then choose Jung Jungyeob Collection for each starting node under Saved graphs.
...
![Screenshot 1](images/image5.jpg)  
![Screenshot 2](images/image6.jpg)
...
○ The Collection Visualization Beta, developed based on the Rim Dongsik Collection, can be accessed via the [SeMA AA GitHub account (Click)](https://github.com/SeMA-AA).
